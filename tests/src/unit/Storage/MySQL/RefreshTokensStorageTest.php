...
class RefreshTokensStorageTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$refresh_token_table_name = self::$MySQLTestAsset->getRefreshTokenTableName();
        self::$refresh_token_length = self::$MySQLTestAsset->getRefreshTokenLength();
        self::$RefreshTokensStorage = self::$MySQLTestAsset->getRefreshTokensStorage();
    }

    /**
     * @test
     * @covers FR\OAuth2\Storage\MySQL\RefreshTokensStorage::__construct
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\MySQL\RefreshTokensStorage::createDBStructure
     * 
     * @return void
     */
    public function createDBStructure()
    {
        ...
        $values = [
            ':refresh_token_table_name' => str_replace('`', '', strtolower(self::$refresh_token_table_name)),
        ];
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\MySQL\RefreshTokensStorage::insertRefreshToken
     * 
     * @return array
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\MySQL\RefreshTokensStorage::getRefreshToken
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\MySQL\RefreshTokensStorage::deleteRefreshToken
     * @depends insertRefreshToken
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\MySQL\RefreshTokensStorage::getExpiredRefreshTokens
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\MySQL\RefreshTokensStorage::deleteExpiredRefreshTokens
     * 
     * @return void
     */
