...
class AccessTokensStorageTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$access_token_table_name = self::$OracleTestAsset->getAccessTokenTableName();
        self::$access_token_length = self::$OracleTestAsset->getAccessTokenLength();
        self::$AccessTokensStorage = self::$OracleTestAsset->getAccessTokensStorage();
    }

    /**
     * @test
     * @covers FR\OAuth2\Storage\Oracle\AccessTokensStorage::__construct
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\Oracle\AccessTokensStorage::createDBStructure
     * 
     * @return void
     */
    public function createDBStructure()
    {
        ...
        $values = [
            ':access_token_table_name' => str_replace('"', '', strtoupper(self::$access_token_table_name)),
        ];
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\Oracle\AccessTokensStorage::insertAccessToken
     * 
     * @return array
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\Oracle\AccessTokensStorage::getAccessToken
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\Oracle\AccessTokensStorage::deleteAccessToken
     * @depends insertAccessToken
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\Oracle\AccessTokensStorage::getExpiredAccessTokens
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\OAuth2\Storage\Oracle\AccessTokensStorage::deleteExpiredAccessTokens
     * 
     * @return void
     */
